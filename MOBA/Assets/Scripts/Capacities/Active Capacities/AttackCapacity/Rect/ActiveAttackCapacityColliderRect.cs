...
namespace Entities.Capacities
{
    public class ActiveAttackCapacityColliderRect : ActiveAttackCapacityCollider
    {
        public override void InitCapacityCollider(ActiveCapacity activeCapacity)
        {
            ...
            ActiveAttackRectCapacitySO activeAttackRectCapacitySo =
                (ActiveAttackRectCapacitySO)CapacitySOCollectionManager.GetActiveCapacitySOByIndex(activeCapacity
                    .indexOfSOInCollection);
