	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_6_0 = ( IN.ase_color * ( ( pow( texCoord8.y , 1.0 ) * tex2D( _TextureSample0, texCoord14 ) ) * 5.0 ) );
...
Node;AmplifyShaderEditor.SamplerNode;7;-1296,128;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;91e5a5de1601d7441a12bfbd27ae58ab;91e5a5de1601d7441a12bfbd27ae58ab;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4149F219CF4306D0CB20CF8F781A3B41645C1000