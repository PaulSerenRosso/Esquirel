	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( _Color * ( ( IN.ase_color * temp_output_13_0 ) * _MainIns ) ).rgb;
				float Alpha = ( _Color.a * ( IN.ase_color.a * temp_output_13_0 ) ).r;
...
ASEEND*/
//CHKSM=370B0E5A7AF9A8C2C265DEA94FA6581CC169117A