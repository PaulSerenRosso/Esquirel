	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( pow( tex2DNode20 , temp_cast_0 ) * IN.ase_color * _Main_Ins * _Tint_Color ).rgb;
				float Alpha = ( IN.ase_color.a * saturate( distanceDepth17 ) * ( tex2DNode20.a * IN.ase_color.a ) );
...
Node;AmplifyShaderEditor.ColorNode;23;-688,-320;Inherit;False;Property;_Tint_Color;Tint_Color;4;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0.7490196,0.7490196,0.7490196,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=07E756962B383D87EF0681FC995AB299C81B04F9